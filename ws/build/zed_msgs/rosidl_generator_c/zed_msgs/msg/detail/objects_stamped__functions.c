...
zed_msgs__msg__ObjectsStamped__init(zed_msgs__msg__ObjectsStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    zed_msgs__msg__ObjectsStamped__fini(msg);
    return false;
  }
  // objects
  if (!zed_msgs__msg__Object__Sequence__init(&msg->objects, 0)) {
    zed_msgs__msg__ObjectsStamped__fini(msg);
    return false;
  }
  return true;
...
zed_msgs__msg__ObjectsStamped__fini(zed_msgs__msg__ObjectsStamped * msg)
{
  ...
  // objects
  zed_msgs__msg__Object__Sequence__fini(&msg->objects);
}
...
zed_msgs__msg__ObjectsStamped__are_equal(const zed_msgs__msg__ObjectsStamped * lhs, const zed_msgs__msg__ObjectsStamped * rhs)
{
  ...
  // objects
  if (!zed_msgs__msg__Object__Sequence__are_equal(
  ...
  zed_msgs__msg__ObjectsStamped * output)
{
  ...
  // objects
  if (!zed_msgs__msg__Object__Sequence__copy(
...
zed_msgs__msg__ObjectsStamped__create()
{
  ...
  zed_msgs__msg__ObjectsStamped * msg = (zed_msgs__msg__ObjectsStamped *)allocator.allocate(sizeof(zed_msgs__msg__ObjectsStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(zed_msgs__msg__ObjectsStamped));
  bool success = zed_msgs__msg__ObjectsStamped__init(msg);
  if (!success) {
...
zed_msgs__msg__ObjectsStamped__Sequence__init(zed_msgs__msg__ObjectsStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zed_msgs__msg__ObjectsStamped * data = NULL;

  if (size) {
    data = (zed_msgs__msg__ObjectsStamped *)allocator.zero_allocate(size, sizeof(zed_msgs__msg__ObjectsStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = zed_msgs__msg__ObjectsStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        zed_msgs__msg__ObjectsStamped__fini(&data[i - 1]);
      }
...
zed_msgs__msg__ObjectsStamped__Sequence__fini(zed_msgs__msg__ObjectsStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      zed_msgs__msg__ObjectsStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zed_msgs__msg__ObjectsStamped__Sequence * array = (zed_msgs__msg__ObjectsStamped__Sequence *)allocator.allocate(sizeof(zed_msgs__msg__ObjectsStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = zed_msgs__msg__ObjectsStamped__Sequence__init(array, size);
  if (!success) {
...
zed_msgs__msg__ObjectsStamped__Sequence__destroy(zed_msgs__msg__ObjectsStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    zed_msgs__msg__ObjectsStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
zed_msgs__msg__ObjectsStamped__Sequence__are_equal(const zed_msgs__msg__ObjectsStamped__Sequence * lhs, const zed_msgs__msg__ObjectsStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!zed_msgs__msg__ObjectsStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  zed_msgs__msg__ObjectsStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(zed_msgs__msg__ObjectsStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    zed_msgs__msg__ObjectsStamped * data =
      (zed_msgs__msg__ObjectsStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!zed_msgs__msg__ObjectsStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          zed_msgs__msg__ObjectsStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!zed_msgs__msg__ObjectsStamped__copy(
