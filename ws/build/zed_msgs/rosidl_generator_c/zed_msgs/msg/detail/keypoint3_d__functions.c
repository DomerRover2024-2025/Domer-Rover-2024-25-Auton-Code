...
zed_msgs__msg__Keypoint3D__create()
{
  ...
  zed_msgs__msg__Keypoint3D * msg = (zed_msgs__msg__Keypoint3D *)allocator.allocate(sizeof(zed_msgs__msg__Keypoint3D), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(zed_msgs__msg__Keypoint3D));
  bool success = zed_msgs__msg__Keypoint3D__init(msg);
  if (!success) {
...
zed_msgs__msg__Keypoint3D__destroy(zed_msgs__msg__Keypoint3D * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    zed_msgs__msg__Keypoint3D__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
zed_msgs__msg__Keypoint3D__Sequence__init(zed_msgs__msg__Keypoint3D__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zed_msgs__msg__Keypoint3D * data = NULL;

  if (size) {
    data = (zed_msgs__msg__Keypoint3D *)allocator.zero_allocate(size, sizeof(zed_msgs__msg__Keypoint3D), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = zed_msgs__msg__Keypoint3D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        zed_msgs__msg__Keypoint3D__fini(&data[i - 1]);
      }
...
zed_msgs__msg__Keypoint3D__Sequence__fini(zed_msgs__msg__Keypoint3D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      zed_msgs__msg__Keypoint3D__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zed_msgs__msg__Keypoint3D__Sequence * array = (zed_msgs__msg__Keypoint3D__Sequence *)allocator.allocate(sizeof(zed_msgs__msg__Keypoint3D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = zed_msgs__msg__Keypoint3D__Sequence__init(array, size);
  if (!success) {
...
zed_msgs__msg__Keypoint3D__Sequence__destroy(zed_msgs__msg__Keypoint3D__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    zed_msgs__msg__Keypoint3D__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
zed_msgs__msg__Keypoint3D__Sequence__are_equal(const zed_msgs__msg__Keypoint3D__Sequence * lhs, const zed_msgs__msg__Keypoint3D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!zed_msgs__msg__Keypoint3D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  zed_msgs__msg__Keypoint3D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(zed_msgs__msg__Keypoint3D);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    zed_msgs__msg__Keypoint3D * data =
      (zed_msgs__msg__Keypoint3D *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!zed_msgs__msg__Keypoint3D__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          zed_msgs__msg__Keypoint3D__fini(&output->data[i]);
        }
        return false;
      }
    }
