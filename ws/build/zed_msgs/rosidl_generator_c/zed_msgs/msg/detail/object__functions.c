...
zed_msgs__msg__Object__init(zed_msgs__msg__Object * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->label)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  // label_id
  // sublabel
  ...
  // action_state
  // bounding_box_2d
  if (!zed_msgs__msg__BoundingBox2Di__init(&msg->bounding_box_2d)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  // bounding_box_3d
  if (!zed_msgs__msg__BoundingBox3D__init(&msg->bounding_box_3d)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  // dimensions_3d
  ...
  if (!zed_msgs__msg__BoundingBox2Df__init(&msg->head_bounding_box_2d)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  // head_bounding_box_3d
  if (!zed_msgs__msg__BoundingBox3D__init(&msg->head_bounding_box_3d)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  // head_position
  // skeleton_2d
  if (!zed_msgs__msg__Skeleton2D__init(&msg->skeleton_2d)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  // skeleton_3d
  if (!zed_msgs__msg__Skeleton3D__init(&msg->skeleton_3d)) {
    zed_msgs__msg__Object__fini(msg);
    return false;
  }
  return true;
...
zed_msgs__msg__Object__fini(zed_msgs__msg__Object * msg)
{
  ...
  // action_state
  // bounding_box_2d
  zed_msgs__msg__BoundingBox2Di__fini(&msg->bounding_box_2d);
  // bounding_box_3d
  zed_msgs__msg__BoundingBox3D__fini(&msg->bounding_box_3d);
  // dimensions_3d
  // skeleton_available
  // body_format
  // head_bounding_box_2d
  zed_msgs__msg__BoundingBox2Df__fini(&msg->head_bounding_box_2d);
  // head_bounding_box_3d
  zed_msgs__msg__BoundingBox3D__fini(&msg->head_bounding_box_3d);
  // head_position
  // skeleton_2d
  zed_msgs__msg__Skeleton2D__fini(&msg->skeleton_2d);
  // skeleton_3d
  zed_msgs__msg__Skeleton3D__fini(&msg->skeleton_3d);
}
...
zed_msgs__msg__Object__are_equal(const zed_msgs__msg__Object * lhs, const zed_msgs__msg__Object * rhs)
{
  ...
  // bounding_box_2d
  if (!zed_msgs__msg__BoundingBox2Di__are_equal(
      &(lhs->bounding_box_2d), &(rhs->bounding_box_2d)))
  {
    return false;
  }
  // bounding_box_3d
  if (!zed_msgs__msg__BoundingBox3D__are_equal(
  ...
  // head_bounding_box_2d
  if (!zed_msgs__msg__BoundingBox2Df__are_equal(
  ...
  // skeleton_2d
  if (!zed_msgs__msg__Skeleton2D__are_equal(
      &(lhs->skeleton_2d), &(rhs->skeleton_2d)))
  {
    return false;
  }
  // skeleton_3d
  if (!zed_msgs__msg__Skeleton3D__are_equal(
  ...
  zed_msgs__msg__Object * output)
{
  ...
  // skeleton_2d
  if (!zed_msgs__msg__Skeleton2D__copy(
...
zed_msgs__msg__Object__create()
{
  ...
  zed_msgs__msg__Object * msg = (zed_msgs__msg__Object *)allocator.allocate(sizeof(zed_msgs__msg__Object), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(zed_msgs__msg__Object));
  bool success = zed_msgs__msg__Object__init(msg);
  if (!success) {
...
zed_msgs__msg__Object__Sequence__init(zed_msgs__msg__Object__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zed_msgs__msg__Object * data = NULL;

  if (size) {
    data = (zed_msgs__msg__Object *)allocator.zero_allocate(size, sizeof(zed_msgs__msg__Object), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = zed_msgs__msg__Object__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        zed_msgs__msg__Object__fini(&data[i - 1]);
      }
...
zed_msgs__msg__Object__Sequence__fini(zed_msgs__msg__Object__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      zed_msgs__msg__Object__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zed_msgs__msg__Object__Sequence * array = (zed_msgs__msg__Object__Sequence *)allocator.allocate(sizeof(zed_msgs__msg__Object__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = zed_msgs__msg__Object__Sequence__init(array, size);
  if (!success) {
...
zed_msgs__msg__Object__Sequence__destroy(zed_msgs__msg__Object__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    zed_msgs__msg__Object__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
zed_msgs__msg__Object__Sequence__are_equal(const zed_msgs__msg__Object__Sequence * lhs, const zed_msgs__msg__Object__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!zed_msgs__msg__Object__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  zed_msgs__msg__Object__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(zed_msgs__msg__Object);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    zed_msgs__msg__Object * data =
      (zed_msgs__msg__Object *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!zed_msgs__msg__Object__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          zed_msgs__msg__Object__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!zed_msgs__msg__Object__copy(
