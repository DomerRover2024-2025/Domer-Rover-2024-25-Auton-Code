...
#ifndef ZED_MSGS__SRV__DETAIL__START_SVO_REC__FUNCTIONS_H_
#define ZED_MSGS__SRV__DETAIL__START_SVO_REC__FUNCTIONS_H_
 ...
 * )) before or use
 * zed_msgs__srv__StartSvoRec_Request__create()
 ...
 * calls
 * zed_msgs__srv__StartSvoRec_Request__init().
...
/**
 * It calls
 * zed_msgs__srv__StartSvoRec_Request__fini()
...
/**
 * It calls
 * zed_msgs__srv__StartSvoRec_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * zed_msgs__srv__StartSvoRec_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_zed_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zed_msgs__srv__StartSvoRec_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zed_msgs
...
/**
 * It calls
 * zed_msgs__srv__StartSvoRec_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zed_msgs
...
/**
 * It calls
 * zed_msgs__srv__StartSvoRec_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ZED_MSGS__SRV__DETAIL__START_SVO_REC__FUNCTIONS_H_
