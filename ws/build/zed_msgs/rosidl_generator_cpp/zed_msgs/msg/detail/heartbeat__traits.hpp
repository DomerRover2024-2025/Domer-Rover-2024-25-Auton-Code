...
#ifndef ZED_MSGS__MSG__DETAIL__HEARTBEAT__TRAITS_HPP_
#define ZED_MSGS__MSG__DETAIL__HEARTBEAT__TRAITS_HPP_
...
inline void to_yaml(
  const zed_msgs::msg::Heartbeat & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const zed_msgs::msg::Heartbeat & msg)
{
  return zed_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<zed_msgs::msg::Heartbeat>()
{
  return "zed_msgs::msg::Heartbeat";
}

template<>
inline const char * name<zed_msgs::msg::Heartbeat>()
{
  return "zed_msgs/msg/Heartbeat";
}

template<>
struct has_fixed_size<zed_msgs::msg::Heartbeat>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<zed_msgs::msg::Heartbeat>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<zed_msgs::msg::Heartbeat>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ZED_MSGS__MSG__DETAIL__HEARTBEAT__TRAITS_HPP_
