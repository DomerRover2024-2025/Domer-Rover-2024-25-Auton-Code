...
#ifndef ZED_MSGS__MSG__DETAIL__PLANE_STAMPED__TRAITS_HPP_
#define ZED_MSGS__MSG__DETAIL__PLANE_STAMPED__TRAITS_HPP_
...
inline void to_yaml(
  const zed_msgs::msg::PlaneStamped & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const zed_msgs::msg::PlaneStamped & msg)
{
  return zed_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<zed_msgs::msg::PlaneStamped>()
{
  return "zed_msgs::msg::PlaneStamped";
}

template<>
inline const char * name<zed_msgs::msg::PlaneStamped>()
{
  return "zed_msgs/msg/PlaneStamped";
}

template<>
struct has_fixed_size<zed_msgs::msg::PlaneStamped>
...
template<>
struct has_bounded_size<zed_msgs::msg::PlaneStamped>
...
template<>
struct is_message<zed_msgs::msg::PlaneStamped>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ZED_MSGS__MSG__DETAIL__PLANE_STAMPED__TRAITS_HPP_
