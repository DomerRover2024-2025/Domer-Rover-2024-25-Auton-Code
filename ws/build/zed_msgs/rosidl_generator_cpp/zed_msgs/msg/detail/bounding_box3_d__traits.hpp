...
#ifndef ZED_MSGS__MSG__DETAIL__BOUNDING_BOX3_D__TRAITS_HPP_
#define ZED_MSGS__MSG__DETAIL__BOUNDING_BOX3_D__TRAITS_HPP_
...
inline void to_yaml(
  const zed_msgs::msg::BoundingBox3D & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const zed_msgs::msg::BoundingBox3D & msg)
{
  return zed_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<zed_msgs::msg::BoundingBox3D>()
{
  return "zed_msgs::msg::BoundingBox3D";
}

template<>
inline const char * name<zed_msgs::msg::BoundingBox3D>()
{
  return "zed_msgs/msg/BoundingBox3D";
}

template<>
struct has_fixed_size<zed_msgs::msg::BoundingBox3D>
  : std::integral_constant<bool, has_fixed_size<zed_msgs::msg::Keypoint3D>::value> {};

template<>
struct has_bounded_size<zed_msgs::msg::BoundingBox3D>
  : std::integral_constant<bool, has_bounded_size<zed_msgs::msg::Keypoint3D>::value> {};

template<>
struct is_message<zed_msgs::msg::BoundingBox3D>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ZED_MSGS__MSG__DETAIL__BOUNDING_BOX3_D__TRAITS_HPP_
