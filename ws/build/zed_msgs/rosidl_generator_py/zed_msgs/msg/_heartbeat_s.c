...
bool zed_msgs__msg__heartbeat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_msgs.msg._heartbeat.Heartbeat", full_classname_dest, 33) == 0);
  }
  zed_msgs__msg__Heartbeat * ros_message = _ros_message;
  {  // beat_count
...
PyObject * zed_msgs__msg__heartbeat__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_msgs.msg._heartbeat");
