...
bool zed_msgs__msg__skeleton2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_msgs.msg._skeleton2_d.Skeleton2D", full_classname_dest, 36) == 0);
  }
  zed_msgs__msg__Skeleton2D * ros_message = _ros_message;
  {  // keypoints
    ...
    Py_ssize_t size = 70;
    zed_msgs__msg__Keypoint2Df * dest = ros_message->keypoints;
...
PyObject * zed_msgs__msg__skeleton2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_msgs.msg._skeleton2_d");
