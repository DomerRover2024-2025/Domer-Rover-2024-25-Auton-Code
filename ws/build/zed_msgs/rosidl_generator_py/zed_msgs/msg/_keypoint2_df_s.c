...
bool zed_msgs__msg__keypoint2_df__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_msgs.msg._keypoint2_df.Keypoint2Df", full_classname_dest, 38) == 0);
  }
  zed_msgs__msg__Keypoint2Df * ros_message = _ros_message;
  {  // kp
...
PyObject * zed_msgs__msg__keypoint2_df__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_msgs.msg._keypoint2_df");
