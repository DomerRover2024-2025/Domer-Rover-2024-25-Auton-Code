...
bool zed_msgs__msg__plane_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_msgs.msg._plane_stamped.PlaneStamped", full_classname_dest, 40) == 0);
  }
  zed_msgs__msg__PlaneStamped * ros_message = _ros_message;
  {  // header
...
PyObject * zed_msgs__msg__plane_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_msgs.msg._plane_stamped");
