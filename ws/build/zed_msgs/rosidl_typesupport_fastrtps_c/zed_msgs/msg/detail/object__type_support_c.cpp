  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounding_box_2d
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zed_msgs, msg, BoundingBox2Di
      )()->data);
  ...
  // Field name: bounding_box_3d
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zed_msgs, msg, BoundingBox3D
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: head_bounding_box_2d
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zed_msgs, msg, BoundingBox2Df
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: skeleton_2d
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zed_msgs, msg, Skeleton2D
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: skeleton_3d
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zed_msgs, msg, Skeleton3D
      )()->data);
    if (!callbacks->cdr_serialize(
