...
{
  new (message_memory) zed_msgs::srv::SetPose_Request(_init);
}

void SetPose_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_msgs::srv::SetPose_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPose_Request_message_member_array[2] = {
  {
    ...
    offsetof(zed_msgs::srv::SetPose_Request, pos),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::srv::SetPose_Request, orient),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPose_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(zed_msgs::srv::SetPose_Request),
...
{
  return &::zed_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, SetPose_Request)() {
  return &::zed_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Request_message_type_support_handle;
}
...
void SetPose_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) zed_msgs::srv::SetPose_Response(_init);
}

void SetPose_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_msgs::srv::SetPose_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPose_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::srv::SetPose_Response, success),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::srv::SetPose_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPose_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(zed_msgs::srv::SetPose_Response),
...
{
  return &::zed_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, SetPose_Response)() {
  return &::zed_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetPose_service_members = {
  ...
  // see get_service_type_support_handle<zed_msgs::srv::SetPose>()
...
get_service_type_support_handle<zed_msgs::srv::SetPose>()
{
  ...
  auto service_type_support =
    &::zed_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, SetPose)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<zed_msgs::srv::SetPose>();
}
