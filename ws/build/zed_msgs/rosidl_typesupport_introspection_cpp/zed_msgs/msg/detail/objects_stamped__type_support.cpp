...
{
  new (message_memory) zed_msgs::msg::ObjectsStamped(_init);
}

void ObjectsStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_msgs::msg::ObjectsStamped *>(message_memory);
  typed_message->~ObjectsStamped();
}

size_t size_function__ObjectsStamped__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<zed_msgs::msg::Object> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<zed_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<zed_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const zed_msgs::msg::Object *>(
    get_const_function__ObjectsStamped__objects(untyped_member, index));
  auto & value = *reinterpret_cast<zed_msgs::msg::Object *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<zed_msgs::msg::Object *>(
    get_function__ObjectsStamped__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const zed_msgs::msg::Object *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectsStamped_message_member_array[2] = {
  {
    ...
    offsetof(zed_msgs::msg::ObjectsStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<zed_msgs::msg::Object>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::ObjectsStamped, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectsStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(zed_msgs::msg::ObjectsStamped),
...
{
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectsStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, msg, ObjectsStamped)() {
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectsStamped_message_type_support_handle;
}
