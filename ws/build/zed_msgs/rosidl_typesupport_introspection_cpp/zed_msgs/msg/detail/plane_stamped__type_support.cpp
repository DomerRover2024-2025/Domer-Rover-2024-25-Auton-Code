...
{
  new (message_memory) zed_msgs::msg::PlaneStamped(_init);
}

void PlaneStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_msgs::msg::PlaneStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PlaneStamped_message_member_array[8] = {
  {
    ...
    offsetof(zed_msgs::msg::PlaneStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, mesh),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, coefficients),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, normal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, center),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, extents),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::PlaneStamped, bounds),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PlaneStamped_message_members = {
  ...
  8,  // number of fields
  sizeof(zed_msgs::msg::PlaneStamped),
...
{
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::PlaneStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, msg, PlaneStamped)() {
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::PlaneStamped_message_type_support_handle;
}
