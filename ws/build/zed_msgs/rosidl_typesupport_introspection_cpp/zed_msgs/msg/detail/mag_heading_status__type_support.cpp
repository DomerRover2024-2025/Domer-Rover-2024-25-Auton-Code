...
{
  new (message_memory) zed_msgs::msg::MagHeadingStatus(_init);
}

void MagHeadingStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_msgs::msg::MagHeadingStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MagHeadingStatus_message_member_array[1] = {
  {
    ...
    offsetof(zed_msgs::msg::MagHeadingStatus, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MagHeadingStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(zed_msgs::msg::MagHeadingStatus),
...
{
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::MagHeadingStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, msg, MagHeadingStatus)() {
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::MagHeadingStatus_message_type_support_handle;
}
