...
{
  new (message_memory) zed_msgs::msg::DepthInfoStamped(_init);
}

void DepthInfoStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_msgs::msg::DepthInfoStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DepthInfoStamped_message_member_array[3] = {
  {
    ...
    offsetof(zed_msgs::msg::DepthInfoStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::DepthInfoStamped, min_depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_msgs::msg::DepthInfoStamped, max_depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DepthInfoStamped_message_members = {
  ...
  3,  // number of fields
  sizeof(zed_msgs::msg::DepthInfoStamped),
...
{
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::DepthInfoStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, msg, DepthInfoStamped)() {
  return &::zed_msgs::msg::rosidl_typesupport_introspection_cpp::DepthInfoStamped_message_type_support_handle;
}
